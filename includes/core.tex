...
Týmto spôsobom zabezpečujeme na klientovi, že sa na súkromné alebo administrátorské stránky dostane iba oprávnený používateľ s platným session údajom, čím zvyšujeme bezpečnosť aplikácie.
 ...
 prepajanie
  ...
  \section{Dockerizácia aplikácie}
...
# Copy the application code and build\COPY . .
...
A tu je relevantná časť \texttt{docker-compose.yml}, ktorá definuje jednotlivé služby a ich závislosti:
...
Vďaka týmto nastaveniam Docker Compose zabezpečí postupné zostavenie a spustenie služieb v správnom poradí, pričom každá vrstva (fe, be, db) je izolovaná vo vlastnom kontajneri.
