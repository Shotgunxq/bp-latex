...
\begin{itemize} \item \textbf{Leaderboard (rebríček)} – používatelia získavajú za správne odpovede body, na základe ktorých sa vytvára dynamický rebríček.
   Umiestnenie používateľa na rebríčku mu poskytuje prehľad o vlastnej výkonnosti v porovnaní s ostatnými študentmi a motivuje ho k ďalšiemu zlepšovaniu.
...
V nasledujúcej časti uvedieme príklad rozhrania na pridávanie úlohy a spôsob jeho prepojenia s databázovým systémom.
