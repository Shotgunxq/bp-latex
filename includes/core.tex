...
proste o tom ze jake funkcionality su, prebiehe to cez api a blabla dalej definujeme poziadavky
rozozname dve role - student a admin 
dame si tu obrazok diagram pripadov pouzitia, co je vlastne to co sme robili v praci
\subsubsection{Požiadavky na systém}
...
Funkcionálne požiadavky sú špecifikácie, ktoré definujú, čo by systém mal robiť a aké funkcie by mal poskytovať používateľom.
 ...
 V našej aplikácii sme identifikovali nasledujúce funkcionálne požiadavky:
\begin{itemize}
  \item Používateľská autentifikácia a autorizácia prostredníctvom \acrshort{ldap}.
  \item Zobrazenie zoznamu úloh a ich kategorizácia podľa tém.
  \item Možnosť vytvoriť testovú sadu z existujúcich úloh alebo automaticky generovaných úloh.
  \item Riešenie úloh v testovej sade s možnosťou využitia nápoved.
  \item Uloženie výsledkov testu do databázy vrátane počtu bodov a použitých nápoved.
  \item Zobrazenie štatistík o úspešnosti riešenia úloh a testov.
  \item Možnosť správy úloh a testov zo strany administrátora (učiteľa).
  \item Zabezpečenie prístupu k funkciám aplikácie na základe rolí používateľov (študent, administrátor).
  \item Možnosť zdieľať úlohy a testy medzi používateľmi.
  \item Zabezpečenie ochrany osobných údajov a citlivých informácií používateľov.
  \item Zabezpečenie ochrany pred neoprávneným prístupom a útokmi na systém.
  \item Zabezpečenie dostupnosti a spoľahlivosti systému.
  \item Zabezpečenie škálovateľnosti systému pre rastúci počet používateľov a úloh.
  \item Zabezpečenie jednoduchého a intuitívneho používateľského rozhrania.
  \item Zabezpečenie podpory pre rôzne zariadenia a prehliadače.
  \item Zabezpečenie možnosti prispôsobenia používateľského rozhrania podľa preferencií používateľov.
  \item Zabezpečenie možnosti exportu a importu úloh a testov.
  \item Zabezpečenie možnosti integrácie s inými systémami a nástrojmi.
  \end{itemize}
...
Nefunkcionálne požiadavky sú špecifikácie, ktoré sa zameriavajú na vlastnosti a kvalitu systému, ako sú výkon, bezpečnosť, použiteľnosť a údržba.
 ...
 \begin{itemize}
  \item Výkon: Systém by mal byť schopný spracovať viac ako 1000 súčasných používateľov bez výrazného zníženia výkonu.
  \item Bezpečnosť: Systém by mal zabezpečiť ochranu osobných údajov a citlivých informácií používateľov, ako aj ochranu pred neoprávneným prístupom a útokmi.
  \item Použiteľnosť: Systém by mal mať jednoduché a intuitívne používateľské rozhranie, ktoré umožňuje rýchlu orientáciu a efektívne vykonávanie úloh.
  \item Údržba: Systém by mal byť navrhnutý tak, aby bol ľahko udržiavateľný a rozšíriteľný, čo znamená, že nové funkcie a vylepšenia by mali byť jednoduché na implementáciu.
  \item Dostupnosť: Systém by mal byť dostupný 24/7 s minimálnym výpadkom.
  \item Škálovateľnosť: Systém by mal byť schopný rásť s počtom používateľov a úloh bez potreby zásadných zmien v architektúre.
  \item Kompatibilita: Systém by mal byť kompatibilný s rôznymi zariadeniami a prehliadačmi.
  \item Zabezpečenie prístupu: Systém by mal zabezpečiť prístup k funkciám na základe rolí používateľov (študent, administrátor).
  \item Zálohovanie a obnova: Systém by mal mať mechanizmy na pravidelné zálohovanie údajov a ich obnovu v prípade zlyhania.
 \end{itemize}
