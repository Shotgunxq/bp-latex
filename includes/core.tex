...
Mechanizmus CORS funguje tak, že server explicitne definuje, kto môže vytvárať požiadavky na jeho API, aké typy požiadaviek sú povolené a aké HTTP metódy sú podporované.
 ...
 \cite{CORS}
 \footnote{API (Application Programming Interface) je rozhranie, ktoré umožňuje komunikáciu a výmenu dát medzi rôznymi softvérovými aplikáciami alebo systémami.}
