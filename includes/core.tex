...
Medzi hlavné výhody patrí interaktívne lekcie, ktoré sú navrhnuté tak, aby boli pútavé a vyžadovali aktívnu účasť študentov, čím zvyšujú efektivitu učenia.
...
Platforma služi na precvičovanie matematických úloh, ale neponúka zdroje pre samostatné štúdium alebo nápovede. 
Taktiež ak chceme naplno využiť všetky funkcie, musíme si zakúpiť licenciu. \cite{viemeto}
...
Vieme Matiku & Online kurzy matematiky & Základné školy, maturanti & Čiastočne bezplatná \\ \hline
\end{tabularx}
\end{table}

\section{Použuté technológie a knižnice}
